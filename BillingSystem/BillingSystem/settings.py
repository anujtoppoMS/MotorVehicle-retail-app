...
SECRET_KEY = 'django-insecure-wz3d2p1e)g=2h!om!(poe*^wn&tgduyz2ag*ba($qykbfle#ci'
...
# EMAIL_HOST_USER = 'anujtoppo928@gmail.com'
# EMAIL_HOST_PASSWORD = 'ddzl huhl tuou mvcn'
